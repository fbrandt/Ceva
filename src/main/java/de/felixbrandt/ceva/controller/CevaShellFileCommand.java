...
public class CevaShellFileCommand extends de.felixbrandt.support.ShellFileCommand
        implements Command
{
  ...
  public CevaShellFileCommand(String command, InputStream stdin, int timelimit)
  {
